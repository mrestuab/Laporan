...
\begin{figure}[H]
    ...
    \caption{Form Tambah Alat Media}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/bab4/lupa_password.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/bab4/hasil.png}
    \caption{Hasil Pengujian Aplikasi}
    \label{fig:hasil-pengujian}
\end{figure}
